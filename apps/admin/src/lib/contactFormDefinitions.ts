...
export function getContactFormDefinition(slug: string) {
  return CONTACT_FORM_DEFINITIONS[slug];
}
...
export function resolveOptionLabel(formSlug: string, fieldSlug: string, value: string): string | null {
...
export function resolveOptionLabels(formSlug: string, fieldSlug: string, values: string[]): string[] {
